...
<section class="content" th:fragment="content">
	<div class="row">
			...
			<div class="box overflow-hidden pull-up">
				<div class="box-body">
					...
					<div>
						...
						<h3 class="text-white mb-0 font-weight-500">${nbClient} <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="box overflow-hidden pull-up">
				<div class="box-body">
					...
					<div>
						...
						<h3 class="text-white mb-0 font-weight-500">${nbVillage} <small class="text-success"><i class="fa fa-caret-up"></i> +2.5%</small></h3>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="box overflow-hidden pull-up">
				<div class="box-body">
					...
					<div>
						...
						<h3 class="text-white mb-0 font-weight-500">${nbUser} <small class="text-danger"><i class="fa fa-caret-down"></i> -0.5%</small></h3>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-xl-6 col-12">
			<div class="box bg-info bg-img" th:style="'background-image: url('+ @{images/bg-1.png} +');'" style="background-image: url(images/bg-1.png);">
				<div class="box-body text-center">
					<img th:src="@{images/trophy.png}" src="images/trophy.png" class="mt-50" alt="" />
			...
			<div class="box overflow-hidden">
				<div class="box-body p-0">
					<div class="row no-gutters">
						...
						<div class="col-md-6 col-12">
							<div class="box no-shadow mb-0 bg-img rounded-0" data-overlay="5" th:style="'background-image: url('+@{images/gallery/landscape7.jpg}+')'" style="background-image: url(images/gallery/landscape7.jpg)">
								<div class="box-header no-border">
									<h4 class="box-title mb-0">
							...
							<tbody>
									...
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" th:style="'background-image: url('+@{images/gallery/creative/img-1.jpg}+')'" style="background-image: url(images/gallery/creative/img-1.jpg)"></div>
											</div>
								...
								<tr>
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" th:style="'background-image: url('+ @{images/gallery/creative/img-2.jpg} +')'" style="background-image: url(images/gallery/creative/img-2.jpg)"></div>
											</div>
								...
								<tr>
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" th:style="'background-image: url('+ @{images/gallery/creative/img-3.jpg}+')'" style="background-image: url(images/gallery/creative/img-3.jpg)"></div>
											</div>
								...
								<tr>
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" th:style="'background-image: url('+ @{images/gallery/creative/img-4.jpg} +')'" style="background-image: url(images/gallery/creative/img-4.jpg)"></div>
											</div>
								...
								<tr>
									<td class="pl-0 py-8">
										<div class="d-flex align-items-center">
											<div class="flex-shrink-0 mr-20">
												<div class="bg-img h-50 w-50" th:style="'background-image: url('+ @{images/gallery/creative/img-5.jpg} +')'" style="background-image: url(images/gallery/creative/img-5.jpg)"></div>
											</div>
